...
/**
 * 20090818, Henri: Update the MarkerManager marker caching, modified from #onMarkerMoved_
 */
MarkerManager.prototype.updateMarker = function (marker, oldPoint, newPoint) {
	  // NOTE: We do not know the minimum or maximum zoom the marker was
	  // added at, so we start at the absolute maximum. Whenever we successfully
	  // remove a marker at a given zoom, we add it at the new grid coordinates.
	  var me = this;
 ...
 */
//20090818, Henri: already supported since Google Maps API 2.88
/* 
