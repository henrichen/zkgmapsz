...
public class MapMoveEvent extends Event {
	...
	public static final MapMoveEvent getMapMoveEvent(AuRequest request) {
		...
		final double swlat = ((Double)data.get("swlat")).doubleValue();
		final double swlng = ((Double)data.get("swlng")).doubleValue();
		final double nelat = ((Double)data.get("nelat")).doubleValue();
		final double nelng = ((Double)data.get("nelng")).doubleValue();
