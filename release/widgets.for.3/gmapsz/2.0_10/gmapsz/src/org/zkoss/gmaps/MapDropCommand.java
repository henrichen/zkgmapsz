...
/*package*/ class MapDropCommand extends Command {
	...
	protected void process(AuRequest request) {
		...
		final int x = Integer.parseInt(data[3]);
		final int y = Integer.parseInt(data[4]);
		final int clientX = Integer.parseInt(data[5]);
		final int clientY = Integer.parseInt(data[6]);
